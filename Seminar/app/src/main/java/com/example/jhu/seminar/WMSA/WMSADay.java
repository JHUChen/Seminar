...
//run-as com.example.jhu.seminar cat /data/data/com.example.jhu.seminar/databases/test > /sdcard/test

public class WMSADay extends Fragment {
    ...
    static final String tb_name="days";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_wmsa_day, container, false);
    }
    ...
    public void load() {
        ...
        btn = (LinearLayout)getActivity().findViewById(R.id.btnbtn);
        btn_layout = (ViewGroup) btn.getParent();
        speed = (Button)getActivity().findViewById(R.id.speed_2);
        distance = (Button)getActivity().findViewById(R.id.distance_2);
        frequency = (Button)getActivity().findViewById(R.id.frequency_2);
    ...
    /*private void select() {
        String[] tableColumns = {"email", "name", "phone", "relationship"};
        ...
        if(c.getCount() != 0) {
            ...
            phoneET.setText(c.getString(2));
            spinner.setSelection(Integer.valueOf(c.getInt(3)));
        }
        else {
            Toast.makeText(this, "NONONO", Toast.LENGTH_LONG).show();
        }
    }*/
    ...
    private class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                // localhost: 10.0.2.2
                url = new URL("http://intern.here-apps.com/JMLab/SemFinal/selweek.php");
        ...
        protected void onPostExecute(String result) {
            ...
            else
            {
                ...
                lv = (ListView)getActivity().findViewById(R.id.List_4);
